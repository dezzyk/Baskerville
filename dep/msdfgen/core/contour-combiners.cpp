...
static void initDistance(double &distance) {
    distance = SignedDistance::_INFINITE.distance;
}

static void initDistance(MultiDistance &distance) {
    distance.r = SignedDistance::_INFINITE.distance;
    distance.g = SignedDistance::_INFINITE.distance;
    distance.b = SignedDistance::_INFINITE.distance;
}
